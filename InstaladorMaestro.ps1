...
Write-Host "|                                                                          |" -ForegroundColor Cyan
Write-Host "|                  INSTALADOR AUTOMATICO - EGRESAPP2                       |" -ForegroundColor Yellow
Write-Host "|                                                                          |" -ForegroundColor Cyan
Write-Host "|              Sistema de Gestion de Egresados                             |" -ForegroundColor White
Write-Host "|                                                                          |" -ForegroundColor Cyan
Write-Host "============================================================================" -ForegroundColor Cyan
Write-Host ""
Write-Host "Este instalador configurara automaticamente:" -ForegroundColor White
...
if ($ErrorCount -eq 0) {
    ...
    Write-Host "[!] La instalacion se completo con algunos errores" -ForegroundColor Yellow
    Write-Host ""
