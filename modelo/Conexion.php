<?php
/**
 * Clase de Conexión con Auto-Sincronización
 * 
 * Al instanciar esta clase:
 * 1. Intenta conectarse al SERVIDOR_CENTRAL (26.234.93.144)
 * 2. Si conecta, sincroniza datos automáticamente (Central -> Local)
 * 3. Siempre trabaja con la base de datos LOCAL
 * 4. Si no puede conectar al central, trabaja solo con datos locales
 */
...
class Conexion extends PDO {
    ...
    private $central_pass = 'Servicios2025!';
    ...
    public function __construct() {
        ...
        // Intentar sincronización automática desde servidor central
    ...
    private function copiarDatosCentralALocal($pdo_central) {
        try {
            ...
            // No lanzar excepción, permitir que la app continúe con datos locales
        }
    }
